...
import { BucketData, FontCategory, FontData, FontStyle } from "./types";
import { BUCKET_SIZE, encodeBucketCoverage, getBucketForCodePoint, getBucketJsonPathForCodePoint } from "./utils";
import { CodePointSet } from "./CodePointSet";
import { forEachCodePointInString, parseCssUnicodeRangeString } from "./css";

export async function buildFontsData(
  categories: string[],
